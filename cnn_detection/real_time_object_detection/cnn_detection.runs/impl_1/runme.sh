...
HD_PWD='C:/Users/bless/cnn_detection/cnn_detection.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TOP_integration_uart.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TOP_integration_uart.tcl -notrace
