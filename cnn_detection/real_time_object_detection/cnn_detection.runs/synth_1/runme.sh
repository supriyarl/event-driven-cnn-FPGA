...
HD_PWD='C:/Users/bless/cnn_detection/cnn_detection.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TOP_integration_uart.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TOP_integration_uart.tcl
